...
<!-- TF-IDF指標は、「ある文書に対し、その文書に出現する頻度が高く、かつ他の文書には出現しない単語は重要」という事実に基づいた指標です。
1つの文書中のある1単語の頻度を表すTFと全文書中のある1単語の希少性を表すIDFの積で計算されます。
...
ただし、参照したDB発話を見ると分かるように元のコーパスの精度が良くないとも考えられます。 -->
